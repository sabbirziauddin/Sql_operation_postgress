-- Active: 1747583993875@@127.0.0.1@5432@conservation_db@public
...
INSERT INTO rangers (ranger_id,name, region) VALUES (4,'Darix Fox', 'Coastal Plains');
SELECT* FROM rangers;
...
SELECT   sighting_id as sighting_Id,
CASE 
